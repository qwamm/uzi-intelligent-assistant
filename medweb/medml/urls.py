...
urlpatterns = [
    ...
    path('uzi/', include([
      ...
      path('segment/', include([
        path('group/<int:uzi_img_id>/', views.UZISegmentGroupListView.as_view(), name='uzi_segment_group_list'),
        path('group/create/<int:uzi_img_id>/', views.UZISegmentGroupCreateView.as_view(), name='uzi_segment_group_create'),
        path('group/create/solo/<int:uzi_img_id>/', views.UZISegmentGroupCreateSoloView.as_view(), name='uzi_segment_group_create_solo'),
        path('group/update/<int:id>/', views.UZISegmentGroupUpdateDeleteView.as_view(), name='uzi_segment_group_update_delete'),
        

        path('add/', views.UZISegmentAddView.as_view(), name='uzi_segment_add'),
        path('update/<int:id>/', views.UZISegmentUpdateDeleteView.as_view(), name='uzi_segment_update_delete'),
        path('copy/<int:id>/', views.UziSegmentCopyView.as_view(), name='uzi_segment_copy'),
