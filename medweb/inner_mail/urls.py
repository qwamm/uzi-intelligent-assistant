    ...
    path(
        ...
        include(
            [
                path(
                    "simple/",
                    views.SimpleMailCreateGenerics.as_view(),
                    name="simple_mail",
                ),
                path(
                    "expert/",
                    views.ExpertMailCreateGenerics.as_view(),
                    name="expert_mail",
                ),
            ]
        ),
